...
- each line after the first contains edges and vertices under the format "vertex vertex cost" <Enter>  NOTE: in the readFromFile() function in graph class, path must be CHANGED ; it is currently set to my current FULL PATH  
